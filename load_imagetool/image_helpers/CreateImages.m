...
%
% @param imgs_path either 
% 1) a path to a folder contain only image files (or other folders which will be ignored), 
% 2) a variable with the images as xdim x ydim x num_colors x num_images size, 
% 3) a path to a file that contains a variable called I that has images as xdim x ydim x num_colors x num_images, or
% 4) a path to a folder containing a single .mat file containing a variable called I that has images as xdim x ydim x num_colors x num_images.
